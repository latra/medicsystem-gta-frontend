          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              {examData.categories.map((category, categoryIndex) => (
                <div key={`category-edit-${categoryIndex}-${category.name || 'new'}`} className="bg-white shadow-sm rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {category.questions.map((question, questionIndex) => (
                      <div key={`question-edit-${categoryIndex}-${questionIndex}-${question.question.slice(0, 20) || 'new'}`} className="border border-gray-200 rounded-md p-4">
                        ...
                        <div className="mb-3">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {question.options.map((option, optionIndex) => (
                              <input
                                key={`option-edit-input-${categoryIndex}-${questionIndex}-${optionIndex}`}
                                type="text"
                        ...
                        <div>
                          ...
                          >
                            ...
                            {question.options.map((option, optionIndex) => (
                              <option key={`option-edit-select-${categoryIndex}-${questionIndex}-${optionIndex}`} value={option}>
